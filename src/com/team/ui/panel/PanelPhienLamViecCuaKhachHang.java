...
public class PanelPhienLamViecCuaKhachHang extends BasePanel {
    ...
    public void addComp() {
        ...
        add(btn_gioHang);
        btn_lichSu = createButton("Lịch sử mua hàng", 150, btn_gioHang.getY() + 70, font2, Color.BLACK, BT_lichSu);
        btn_lichSu.setSize(450, 50);
        add(btn_lichSu);
        btn_khac = createButton("Chức năng khác", 150, btn_lichSu.getY() + 70, font2, Color.BLACK, BT_khac);
