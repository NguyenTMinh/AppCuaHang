...
public class PanelCuaHangDK extends BasePanel{
	...
	public void addComp() {
		...
		pn_infoSP.setBackground(Color.WHITE);
		...
		lb_PQuayLai.setBackground(Color.WHITE);
		...
		lb_PTitle = createLabel("Nhập thông tin sản phẩm", 0, 40, font1, Color.BLACK, Color.WHITE);
		x = pn_infoSP.getWidth()/2 - lb_PTitle.getWidth()/2;
		lb_PTitle.setLocation(x, lb_PTitle.getY());
		pn_infoSP.add(lb_PTitle);
		lb_PMaSp = createLabel("Mã sản phẩm:", 50, lb_PTitle.getY()+lb_PTitle.getHeight()+30, font2, Color.BLACK, Color.WHITE);
		...
		lb_PTenSp = createLabel("Tên sản phẩm:", 0, lb_PMaSp.getY()+lb_PMaSp.getHeight()+20, font2, Color.BLACK, Color.WHITE);
		...
		lb_PPhanLoai = createLabel("Loại sản phẩm:", 0, lb_PTenSp.getY()+lb_PTenSp.getHeight()+20, font2, Color.BLACK, Color.WHITE);
		...
		lb_PThongTin = createLabel("Thông tin sản phẩm:", 0, lb_PPhanLoai.getY()+lb_PPhanLoai.getHeight()+20, font2, Color.BLACK, Color.WHITE);
		...
		pn_infoSP.add(sp);
		lb_PSoLuong = createLabel("Số lượng kho:", 0, sp.getY()+sp.getHeight()+20, font2, Color.BLACK, Color.WHITE);
		...
		lb_GiaTien = createLabel("Giá tiền:", 0, lb_PSoLuong.getY()+lb_PSoLuong.getHeight()+20, font2, Color.BLACK, Color.WHITE);
		...
		lb_PImage = createLabel("Ảnh sản phẩm:", 0, lb_GiaTien.getY()+lb_GiaTien.getHeight()+20, font2, Color.BLACK, Color.WHITE);
